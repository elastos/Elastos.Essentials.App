export const fr = {
    ...
    'dposvoting': {
        ...
        'reg-dpos-balance-not-enough': 'Un dépôt de 2000 ELA ainsi que des frais de transaction mineurs sont requis pour l\'enregistrement d\'un noeud DPoS',
        'dpos-deposit-warning': 'Souhaitez-vous enregistrer votre noeud DPoS? Un dépôt de 2000 ELA ainsi que des frais de transaction mineurs seront payés pour l\'enregistrement',
