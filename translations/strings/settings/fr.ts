export const fr = {
    ...
    'settings': {
        ...
        'wallet-connect-no-address': "Pas de portefeuille actif, ou le réseau actif n'est pas compatible Ethereum (mais vous pouvez continuer).",
        ...
        'privacy-use-hive-data-sync': 'Utiliser mon stockage Elastos Hive pour sauver et restorer mes données personnelles telles que mon profil DID ou mes contacts',
        'privacy-dont-use-hive-data-sync': 'Ne pas utiliser mon stockage Elastos Hive pour sauver et restorer mes données personnelles',
        ...
        'privacy-dont-send-credential-toolbox-stats': 'Ne pas envoyer de stats anonymes d\'utilisation des crédentiels DID vers la boîte à outils pour développeurs.',
