export const fr = {
    ...
    'launcher': {
        ...
        'tip-message-welcome': 'Merci d\'avoir choisi cette application! Elastos Essentials vous permet de gérer <b>votre identité numérique</b>, votre <b>stockage personnel</b>, vos contacts, et vos <b>portefeuilles</b> de crypto-monnaies. Vous pouvez utiliser tout, ou seulement une partie de ces fonctionnalités.<br/><br/>Elastos Essentials est aussi votre <b>super boîte à outils</b> pour faire fonctionner d\'autres applications, un peu comme MetaMask (si vous connaissez), mais pour plus de fonctionnalités que les cryptos.',
