export const fr = {
    'easybridge': {
        ...
        "intro-2": "De plus, pour commencer rapidement, vous recevrez 0.01 ELA la première fois pour le gas initial.",
        "glide-intro": "Pour des opérations plus avancées ou une plus grande personalisation, touchez ici pour vous rendre sur Glide Finance.",
