export const zh = {
    ...
    'launcher': {
        ...
        'app-settings': '设置',
        'app-settings-description': '管理 Elastos Essentials',
        ...
        'tip-message-welcome': '感谢您使用此应用程序！ Elastos Essentials 可以管理您的<b>数字身份</b>，您的<b>个人存储</b>，您的联系人以及您的加密货币<b>钱包</b>。您可以使用部分或全部这些功能。<br/><br/>当运行其他应用程序时，Elastos Essentials 还是<b>出色的钱包工具</b>。',
        ...
        'tip-message-toolbox': '虽然android和桌面用户可以从 Elastos Essentials 内部访问dApp市场，<b>Elastos Essentials 的主要目的是将其他应用程序作为工具箱提供服务</b>。 乍一看，它可能做的并不多，但它为全新的应用程序和功能开辟了道路。',
        ...
        'tip-message-capsule-marketplace': 'Android和桌面用户可以<b>从胶囊市场中</b>获得胶囊然后安装，即可直接<b>从 Elastos Essentials 内部访问 Elastos Essentials 胶囊</b>。 为了方便起见，这些胶囊可以通过收藏添加到 Elastos Essentials 主屏幕中。<br/><br/>iOS用户必须等待，直到他们喜欢的胶囊的应用程序开发人员在itunes应用商店上发布了Trinity原生版本。',
        ...
        'tip-message-dev-wipe-data': '您知道吗？ 要<b>清除所有应用程序数据</b>，例如删除所有本地存储而不必重新安装该应用程序，请转到 Elastos Essentials 设置并单击<b>清除数据</b>。 您的应用程序将变得像月亮一样干净。',
        'tip-title-dev-trinity-native': 'Trinity 原生',
        'tip-message-dev-trinity-native': '您知道吗？ Elastos Essentials 内的应用程序完成并在 Elastos Essentials 中正常运行后，您可以<b>使用trinity原生工具链将您的应用程序打包为安卓或iOS原生应用程序</b>，而无需更改任何代码。'
    }
