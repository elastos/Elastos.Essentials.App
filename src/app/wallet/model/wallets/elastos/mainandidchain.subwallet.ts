...
export abstract class MainAndIDChainSubWallet extends StandardSubWallet<ElastosTransaction> {
    ...
    public async createReceiveCustomIDTransaction(payload: string, memo = ""): Promise<string> {
        ...
        return this.masterWallet.walletManager.spvBridge.createReceiveCustomIDTransaction(
            this.masterWallet.id,
            this.id,
            JSON.stringify(au.utxo),
            payload,
    ...
    public async createChangeCustomIDFeeTransaction(payload: string, memo = ""): Promise<string> {
        ...
        return this.masterWallet.walletManager.spvBridge.createChangeCustomIDFeeTransaction(
            this.masterWallet.id,
            this.id,
            JSON.stringify(au.utxo),
            payload,
    ...
    public async createRegisterSidechainTransaction(payload: string, memo = ""): Promise<string> {
        ...
        return this.masterWallet.walletManager.spvBridge.createRegisterSidechainTransaction(
            this.masterWallet.id,
            this.id,
            JSON.stringify(au.utxo),
            payload,
