...
import { ElastosStandardNetworkWallet } from '../networkwallets/elastos.networkwallet';

/**
 * Specialized standard sub wallet for the ETH sidechain.
 */
export class ElastosEVMSubWallet extends StandardEVMSubWallet<ElastosWalletNetworkOptions> {
  constructor(networkWallet: ElastosStandardNetworkWallet, id: StandardCoinName) {
