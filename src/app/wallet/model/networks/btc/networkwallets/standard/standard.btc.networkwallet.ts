 ...
 */
export class StandardBTCNetworkWallet<WalletNetworkOptionsType extends WalletNetworkOptions> extends BTCNetworkWallet<
...
> {
  constructor(
    ...
    super(masterWallet, network, bitcoinAddressType, new BTCWalletJSSafe(masterWallet, 'BTC', bitcoinAddressType));
  }
