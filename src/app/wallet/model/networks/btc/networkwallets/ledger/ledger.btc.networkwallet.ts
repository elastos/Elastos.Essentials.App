 ...
 */
export class LedgerBTCNetworkWallet<WalletNetworkOptionsType extends WalletNetworkOptions> extends BTCNetworkWallet<
  LedgerMasterWallet,
  WalletNetworkOptionsType
> {
  constructor(
    public masterWallet: LedgerMasterWallet,
    public network: AnyNetwork,
    public bitcoinAddressType: BitcoinAddressType
  ) {
    super(masterWallet, network, bitcoinAddressType, new BTCLedgerSafe(masterWallet));
  }

  protected async prepareStandardSubWallets(): Promise<void> {
    this.subWallets[StandardCoinName.BTC] = new BTCSubWallet(this);
