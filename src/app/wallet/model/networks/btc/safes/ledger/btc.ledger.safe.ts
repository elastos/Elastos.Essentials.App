...
import { BTCOutputData, BTCSignDataType, BTCSignPsbtOptions, BTCTxData, BTCUTXO } from "src/app/wallet/model/btc.types";
...
export class BTCLedgerSafe extends Safe implements BTCSafe {
  ...
  public signPsbt(_psbtHex: string, _options?: BTCSignPsbtOptions): Promise<string> {
