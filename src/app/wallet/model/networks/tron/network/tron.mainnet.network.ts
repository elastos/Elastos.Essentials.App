...
export class TronMainNetNetwork extends TronNetworkBase {
  ...
  public getAPIUrlOfType(type: NetworkAPIURLType): string {
    if (type === NetworkAPIURLType.RPC) return TronAPI.getApiUrl(TronApiType.RPC, MAINNET_TEMPLATE);
  ...
  public getBuiltInTRC20Coins(): TRC20Coin[] {
    return [new TRC20Coin(this, 'USDT', 'Tether USD', 'TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t', 6, false, true)];
  }
}
