 ...
 */
export class StandardTronNetworkWallet<WalletNetworkOptionsType extends WalletNetworkOptions> extends TronNetworkWallet<
...
> {
  ...
  constructor(public masterWallet: StandardMasterWallet, public network: TronNetworkBase) {
    super(masterWallet, network, new TronWalletJSSafe(masterWallet, StandardCoinName.TRON));
  }

  protected async prepareStandardSubWallets(): Promise<void> {
    this.mainTokenSubWallet = new TronSubWallet(this);
