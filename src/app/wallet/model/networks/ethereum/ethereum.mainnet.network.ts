...
export class EthereumMainNetNetwork extends EVMNetwork {
  constructor() {
    super(
      ...
      1,
      [
        new ERC20Coin("BNB", "BNB", "0xB8c77482e45F1F44dE1745F52C74426C631bDD52", MAINNET_TEMPLATE, false, true),
        new ERC20Coin("USDT", "USDT", "0xdac17f958d2ee523a2206206994597c13d831ec7", MAINNET_TEMPLATE, false, true),
