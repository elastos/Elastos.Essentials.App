...
export class HooMainnetUniswapCurrencyProvider extends UniswapCurrencyProvider {
  private referenceUSDCoin = new ERC20Coin("USDT", "USDT", "0xD16bAbe52980554520F6Da505dF4d1b124c815a7", 6, MAINNET_TEMPLATE, false, true);
  ...
  private wrappedNativeCoin = new ERC20Coin("WHOO", "Wrapped HOO", "0x3EFF9D389D13D6352bfB498BCF616EF9b1BEaC87", 18, MAINNET_TEMPLATE, false, true);
