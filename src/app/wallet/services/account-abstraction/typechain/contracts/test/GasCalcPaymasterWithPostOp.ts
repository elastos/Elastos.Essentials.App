...
export interface GasCalcPaymasterWithPostOpInterface extends utils.Interface {
  functions: {
...
export interface GasCalcPaymasterWithPostOp extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GasCalcPaymasterWithPostOpInterface;
