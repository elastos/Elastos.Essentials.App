...
var Pair = /*#__PURE__*/function () {
  ...
  Pair.getAddressByChainId = function getAddressByChainId(chainId, tokenA, tokenB) {
    ...
    if (((_PAIR_ADDRESS_CACHE3 = PAIR_ADDRESS_CACHE) === null || _PAIR_ADDRESS_CACHE3 === void 0 ? void 0 : (_PAIR_ADDRESS_CACHE3$ = _PAIR_ADDRESS_CACHE3[tokens[0].address]) === null || _PAIR_ADDRESS_CACHE3$ === void 0 ? void 0 : _PAIR_ADDRESS_CACHE3$[tokens[1].address]) === undefined) {
      ...
      PAIR_ADDRESS_CACHE = _extends({}, PAIR_ADDRESS_CACHE, (_extends5 = {}, _extends5[tokens[0].address] = _extends({}, (_PAIR_ADDRESS_CACHE4 = PAIR_ADDRESS_CACHE) === null || _PAIR_ADDRESS_CACHE4 === void 0 ? void 0 : _PAIR_ADDRESS_CACHE4[tokens[0].address], (_extends4 = {}, _extends4[tokens[1].address] = getCreate2Address(getFactoryAddress(chainId), keccak256(['bytes'], [pack(['address', 'address'], [tokens[0].address, tokens[1].address])]), getCodeHash(chainId)), _extends4)), _extends5));
    }
