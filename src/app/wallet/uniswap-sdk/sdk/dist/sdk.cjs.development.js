...
(function (ChainId) {
  ChainId[ChainId["MAINNET"] = 20] = "MAINNET";
...
var FACTORY_ADDRESS = TokSwapConstants.MAINNET.UniswapV2Factory; // export const INIT_CODE_HASH = '0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f'

var INIT_CODE_HASH = TokSwapConstants.MAINNET.INIT_CODE_HASH;
function getFactoryAddress(chainId) {
  switch (chainId) {
    case exports.ChainId.DEV:
      {
        return TokSwapConstants.DEV.UniswapV2Factory;
      }

    case exports.ChainId.TESTNET:
      {
        return TokSwapConstants.TESTNET.UniswapV2Factory;
      }

    case exports.ChainId.MAINNET:
      {
        return TokSwapConstants.MAINNET.UniswapV2Factory;
      }

    case exports.ChainId.HECO_MAINNET:
      {
        return TokSwapConstants.HECO_MAINNET.UniswapV2Factory;
      }

    case exports.ChainId.HECO_TESTNET:
      {
        return TokSwapConstants.HECO_TESTNET.UniswapV2Factory;
      }
...
function getCodeHash(chainId) {
  switch (chainId) {
    case exports.ChainId.DEV:
      {
        return TokSwapConstants.DEV.INIT_CODE_HASH;
      }

    case exports.ChainId.TESTNET:
      {
        return TokSwapConstants.TESTNET.INIT_CODE_HASH;
      }

    case exports.ChainId.MAINNET:
      {
        return TokSwapConstants.MAINNET.INIT_CODE_HASH;
      }

    case exports.ChainId.HECO_MAINNET:
      {
        return TokSwapConstants.HECO_MAINNET.INIT_CODE_HASH;
      }

    case exports.ChainId.HECO_TESTNET:
      {
        return TokSwapConstants.HECO_TESTNET.INIT_CODE_HASH;
      }
...
var Token = /*#__PURE__*/function (_Currency) {
  ...
  _proto.setExtend = function setExtend(extend) {
    this.extend = extend;
  }
  /**
...
var WETH = (_WETH = {}, _WETH[exports.ChainId.MAINNET] = /*#__PURE__*/new Token(exports.ChainId.MAINNET, // '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2',
TokSwapConstants.MAINNET.WETH9, 18, 'WETH', 'Wrapped Ether'), _WETH[exports.ChainId.ROPSTEN] = /*#__PURE__*/new Token(exports.ChainId.ROPSTEN, '0xc778417E063141139Fce010982780140Aa0cD5Ab', 18, 'WETH', 'Wrapped Ether'), _WETH[exports.ChainId.RINKEBY] = /*#__PURE__*/new Token(exports.ChainId.RINKEBY, '0xc778417E063141139Fce010982780140Aa0cD5Ab', 18, 'WETH', 'Wrapped Ether'), _WETH[exports.ChainId.GÖRLI] = /*#__PURE__*/new Token(exports.ChainId.GÖRLI, '0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6', 18, 'WETH', 'Wrapped Ether'), _WETH[exports.ChainId.KOVAN] = /*#__PURE__*/new Token(exports.ChainId.KOVAN, '0xd0A1E359811322d97991E03f863a0C30C2cF029C', 18, 'WETH', 'Wrapped Ether'), _WETH[exports.ChainId.DEV] = /*#__PURE__*/new Token(exports.ChainId.DEV, TokSwapConstants.DEV.WETH9, 18, 'WETH', 'Wrapped Ether'), _WETH[exports.ChainId.TESTNET] = /*#__PURE__*/new Token(exports.ChainId.TESTNET, TokSwapConstants.TESTNET.WETH9, 18, 'WETH', 'Wrapped Ether'), _WETH[exports.ChainId.HECO_MAINNET] = /*#__PURE__*/new Token(exports.ChainId.HECO_MAINNET, TokSwapConstants.HECO_MAINNET.WETH9, 18, 'WETH', 'Wrapped Ether'), _WETH[exports.ChainId.HECO_TESTNET] = /*#__PURE__*/new Token(exports.ChainId.HECO_TESTNET, TokSwapConstants.HECO_TESTNET.WETH9, 18, 'WETH', 'Wrapped Ether'), _WETH);
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'TOK-LP', 'Tokswap LP Token');
  ...
  Pair.getAddressByChainId = function getAddressByChainId(chainId, tokenA, tokenB) {
    ...
    if (((_PAIR_ADDRESS_CACHE3 = PAIR_ADDRESS_CACHE) === null || _PAIR_ADDRESS_CACHE3 === void 0 ? void 0 : (_PAIR_ADDRESS_CACHE3$ = _PAIR_ADDRESS_CACHE3[tokens[0].address]) === null || _PAIR_ADDRESS_CACHE3$ === void 0 ? void 0 : _PAIR_ADDRESS_CACHE3$[tokens[1].address]) === undefined) {
      ...
      PAIR_ADDRESS_CACHE = _extends({}, PAIR_ADDRESS_CACHE, (_extends5 = {}, _extends5[tokens[0].address] = _extends({}, (_PAIR_ADDRESS_CACHE4 = PAIR_ADDRESS_CACHE) === null || _PAIR_ADDRESS_CACHE4 === void 0 ? void 0 : _PAIR_ADDRESS_CACHE4[tokens[0].address], (_extends4 = {}, _extends4[tokens[1].address] = address.getCreate2Address(getFactoryAddress(chainId), solidity.keccak256(['bytes'], [solidity.pack(['address', 'address'], [tokens[0].address, tokens[1].address])]), getCodeHash(chainId)), _extends4)), _extends5));
    }
