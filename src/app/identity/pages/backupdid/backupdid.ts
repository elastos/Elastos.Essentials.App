...
export class BackupDIDPage {
  ...
  private async checkPrintCompleted(): Promise<void> {
    let confirmed: boolean = await this.popup.ionicConfirm("Print confirmation", "Did you successfully print your identity QR Code?", "Yes", "No, try again");
    if (confirmed) {
