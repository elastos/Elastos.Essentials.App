...
export class BackupDIDPage {
  ...
  @ViewChild('qrcode', { static: false }) qrcode: ElementRef;
    ...
    async getActiveSlide() {
      ...
      this.slideIndex === 0 ? titleBarManager.setTitle(this.translate.instant('Your Private QR Code')) :  titleBarManager.setTitle(this.translate.instant('Your Private Key'));
    }
  ...
  async showPrintOptions() {
    ...
    this.uxService.modal.onDidDismiss().then((params) => {
        ...
        if (params && params.data) {
          console.log('Print options params', params);
