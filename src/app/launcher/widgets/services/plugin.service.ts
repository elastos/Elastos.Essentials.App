...
export class WidgetPluginsService implements GlobalService {
    ...
    public getPluginContent(url: string): Promise<PluginConfig<any>> {
        ...
        return this.globalStorageService.getSetting(DIDSessionsStore.signedInDIDString, PERSISTENCE_CONTEXT, key, null);
    }
    ...
    private async savePluginContent(url: string, content: JSONObject) {
        ...
        const key = "plugin-content-" + url;
        await this.globalStorageService.setSetting(DIDSessionsStore.signedInDIDString, PERSISTENCE_CONTEXT, key, content);
    ...
    public async loadPluginsState(): Promise<void> {
        ...
        this.state = <PluginsState>await this.globalStorageService.getSetting(DIDSessionsStore.signedInDIDString, PERSISTENCE_CONTEXT, key, defaultState);
