/**
 * TODO: Make this token definition a shared/root definition for our various kind of "tokens"
 * everywhere inside essentials.
 */
export type ERC20TokenDescriptor = {
...
export const equalTokens = (t1: ERC20TokenDescriptor, t2: ERC20TokenDescriptor): boolean => {
  if (!t1 || !t2)
    return false;
