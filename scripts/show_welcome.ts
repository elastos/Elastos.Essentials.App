...
console.log();
console.log(
  colors.green('  ESSENTIALS_RED_PACKETS_SERVICE_URL') + ' and ' + colors.green('ESSENTIALS_RED_PACKETS_WEB_URL')
);
...
console.log(
  `  Define this variable if you want to run a local credentials toolbox service instead of using the prod apis.`
);
...
console.log();
console.log(colors.green('  USE_TEST_POLLS'));
console.log(`  Controls whether to use test polls in development. Set to 'false' to use production polls.`);
console.log(colors.gray(`  Eg: export USE_TEST_POLLS=false`));
console.log(colors.gray(`  Or: environment/.env: USE_TEST_POLLS=false`));
